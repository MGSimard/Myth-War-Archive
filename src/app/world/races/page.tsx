    ...
    <>
      ...
      <div className="race-wrapper">
        ...
        <p>
          ...
          social system whereby the female possesses a higher status than a male in the common population. They are
          prized to be noble and beautiful. Centaurs live at the top of the ¡°Tree of the World¡±. Since they rely on
          the life water from the ¡°Tree of the World¡±, they are able to live on over hundreds or even a thousand
          years. They love peace and like to live in a quiet environment. When Centaurs choose to apply forces, it is
          mainly because they are protecting their own land or preserving their set of rules. There is no battle in the
          world relevant to justice that Centaurs do not show up. They are born with great agility and have a higher
      ...
      <div className="race-wrapper">
        ...
        <p>
          ...
          cursed again after they sold their souls to the dark lord. Their skin is a weird tinge of blue due to a curse
          by the Gods. This prevents them from ever seeing or being in sunlight. The lands they inhabit are filled with
